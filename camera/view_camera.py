...
class App:
    def __init__(self, window, window_title, video_source=0):
        ...
        self.btn_snapshot=tk.Button(window, text="BACK", command=self.getback)
        ...
        self.btn_quit=tk.Button(window, text='LOGOUT', command=self.logout)
    ...
    def open_camera(self):
        ...
        def notify(title, text):
            os.system("""osascript -e 'display notification "{}" with title "{}"'
              """.format(text, title)) 
        notify("PANOPTES", "Recording has started") 

        #windows
        from win10toast import ToastNotifier
        # create an object to ToastNotifier class
        n = ToastNotifier()
        n.show_toast("ALERT", "Recording started", duration = 30,
        icon_path ="/Users/omniamaher/Desktop/camera/panoptes.ico")
...
class VideoCapture:
    def __init__(self, video_source=0):
        ...
        self.out = cv2.VideoWriter(args.name[0]+'.'+args.type[0],self.fourcc,20,res)# video speed fps
...
class ElapsedTimeClock:
    def __init__(self,window):
        self.T=tk.Label(window,text='00:00:00',font=('times', 20, 'bold'), bg='chocolate2')
    ...
    def tick(self):
        ...
        self.updwin=self.T.after(150, self.tick)
...
class CommandLineParser:
    ...
    def __init__(self):
        ...
        parser.add_argument('--name', nargs=1, default=["/Users/omniamaher/Desktop/panoptes/videos-" + time.strftime("%d-%m-%Y-%H-%M-%S") + ".mp4"], type=str, help='Enter Output video title/name')

        # Parse the arguments and get all the values in the form of namespace.
        # Here args is of namespace and values will be accessed through tag names
        self.args = parser.parse_args()
newpath = "/Users/omniamaher/Desktop/panoptes"
